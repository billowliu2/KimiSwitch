...
export const enTranslations: Record<TranslationKey, string> = {
  ...
  // Health check (ProviderList toolbar button + per-row status dot)
  healthCheck: "Health check",
  healthCheckHint:
    "Probe every enabled provider's inference endpoint and billing query in parallel",
  healthCheckRunning: "Checking…",
  healthSummary: "{ok} OK / {fail} failed",
  healthProbeOk: "Endpoint OK ({latency}ms)",
  healthProbeUnsupported: "Endpoint exposes no model list (404)",
  healthProbeFail: "Endpoint failed: {error}",
  healthUsageOk: "Billing OK",
  healthUsageFail: "Billing failed: {error}",
  healthNotChecked: "Not checked",
  healthRequestFailed: "Health check request failed: {error}",
  healthErrNoBaseUrl: "Missing base URL",
  healthErrNoKey: "No API key configured",
  healthErrAuth: "Authentication failed",
  healthErrNotFound: "Endpoint not found",
  healthErrTimeout: "Connection timed out",
  healthErrUnreachable: "Cannot connect (DNS failure or connection refused)",
  healthErrBadJson: "Response is not valid JSON",
  ...
  apiKeySourceDirect: "Enter key",
  apiKeySourceEnv: "Environment variable",
  apiKeyEnvName: "Variable name",
  apiKeyEnvHint:
    "Only the variable name (api_key_env) is written; Kimi Code reads the secret from its environment. The two sources are mutually exclusive, so switching clears the other.",
  show: "Show",
  hide: "Hide",
  ...
  compactionMaxAttempts: "Max compaction attempts",
  compactionMaxAttemptsHint:
    "Retry limit after a failed context compaction. Empty or 0 leaves the key out of the config (upstream default 5).",
  ...
  // Kimi Code version tracking
  kimiCodeSection: "Kimi Code version",
  kimiCodeInstalled: "Installed",
  kimiCodeLatest: "Latest",
  kimiCodeStatusLabel: "Compatibility",
  kimiCodeStatusCurrent: "Supported",
  kimiCodeStatusOutdated: "Update KimiSwitch recommended",
  kimiCodeStatusPartial: "Partially compatible",
  kimiCodeStatusUnknown: "Unknown version",
  kimiCodeStatusNotInstalled: "Not installed",
  kimiCodeCheck: "Check",
  kimiCodeOpenReleases: "Open releases",
  ...
  usageTemplateSub2api: "Sub2API gateway",
  ...
  usageSub2apiHint: "Query a Sub2API (Wei-Shaw/sub2api) gateway balance / quota (GET /v1/usage). Reuses the inference sk- API key — no extra credentials; the query URL is optionally overridable",
  ...
  usageTierBoosterWallet: "Booster",
  usageThreshold: "Alert threshold",
  usageThresholdHint: "Highlight any window that reaches this percentage; 0 = off",
  usageThresholdAlert: "Threshold reached",
