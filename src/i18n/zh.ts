export const zhTranslations = {
  ...
  // 一键体检（ProviderList 工具栏按钮 + 行内状态点）
  healthCheck: "一键体检",
  healthCheckHint: "并行检测所有启用供应商的推理端点与账单查询",
  healthCheckRunning: "体检中…",
  healthSummary: "{ok} 正常 / {fail} 失败",
  healthProbeOk: "端点正常（{latency}ms）",
  healthProbeUnsupported: "端点不支持模型列表（404）",
  healthProbeFail: "端点失败：{error}",
  healthUsageOk: "账单正常",
  healthUsageFail: "账单失败：{error}",
  healthNotChecked: "未检测",
  healthRequestFailed: "体检请求失败：{error}",
  healthErrNoBaseUrl: "缺少 base_url",
  healthErrNoKey: "未配置 API Key",
  healthErrAuth: "鉴权失败",
  healthErrNotFound: "端点不存在",
  healthErrTimeout: "连接超时",
  healthErrUnreachable: "无法连接（DNS 解析失败或连接被拒绝）",
  healthErrBadJson: "响应不是合法 JSON",
  ...
  apiKeySource: "凭证来源",
  apiKeySourceDirect: "直接填写",
  apiKeySourceEnv: "环境变量",
  apiKeyEnvName: "环境变量名",
  apiKeyEnvHint:
    "只写入变量名（api_key_env），密钥由 Kimi Code 从运行环境读取；两者互斥，切换后会清空另一种。",
  show: "显示",
  hide: "隐藏",
  requestUrl: "请求地址",
  fullUrl: "完整 URL",
  ...
  compactionMaxAttempts: "压缩最大尝试次数",
  compactionMaxAttemptsHint: "上下文压缩失败后的重试上限，留空或 0 表示不写入该项（上游默认 5）。",
  ...
  lastChecked: "上次检查",
  // Kimi Code 版本跟踪
  kimiCodeSection: "Kimi Code 版本",
  kimiCodeInstalled: "已安装版本",
  kimiCodeLatest: "最新版本",
  kimiCodeStatusLabel: "适配状态",
  kimiCodeStatusCurrent: "已适配",
  kimiCodeStatusOutdated: "建议升级 KimiSwitch",
  kimiCodeStatusPartial: "部分兼容",
  kimiCodeStatusUnknown: "未知版本",
  kimiCodeStatusNotInstalled: "未安装",
  kimiCodeCheck: "检查",
  kimiCodeOpenReleases: "打开 Releases",
  ...
  usageTemplateSub2api: "Sub2API 中转站",
  ...
  usageSub2apiHint: "查询 Sub2API (Wei-Shaw/sub2api) 面板的余额 / 额度（GET /v1/usage），自动复用推理 sk- API Key，无需额外凭据；可选覆盖查询地址",
  ...
  usageTierBoosterWallet: "加力钱包",
  usageThreshold: "预警阈值",
  usageThresholdHint: "任一用量窗口达到该百分比时高亮提醒，0 为关闭",
  usageThresholdAlert: "已达预警阈值",
